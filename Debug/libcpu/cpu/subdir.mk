...
libcpu/cpu/%.o: ../libcpu/cpu/%.S
	riscv64-unknown-elf-gcc -x assembler-with-cpp -I"D:\RT-ThreadStudio\workspace\plant_handheld_terminal\libraries\hal_libraries\bmsis\include" -c -mcmodel=medany -march=rv32imc -mabi=ilp32 -x assembler-with-cpp -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@)" -c -o "$@" "$<"
